...
"Business Insights Analyst","Power BI Developer","IT Systems Analyst",
"Transportation Logistics Specialist","Research & Analytics Director","Machine Learning Engineer","Research & Analytics Director","Data Ops","Chief Analytic Officer","Data Learning Engineer","GIS Analyst","Data Visualizers",
"Chief Technology Officer","Health Analytics","Director Marketing Analytics",
"Big Data Developer","Data Developer","Clinical Analytics","Big Data Architect","Python Engineer","Database Manager","Data Visualization Analyst",
"Research Analyst","Data Architect","Statistician","AI Product Manager",
"Quantitative Developer","Principal Big Data Architect","Customer Analytics",
"Web Analytics","Analytics Officer","Health Data Analyts","Data Engineer",
"Database Administrator","Strategic Data Analytics Analyst","Data and Analytics Manager","AI Architect","Data Science Director","Data Manager",
"Reporting/Analytics","Predictive Analytics","Geospatial Data Scientist",
...
df <- df %>%
  mutate(Program = case_when(
      ...
      str_detect(Search, string = "data analyst|data scientist|Business Intelligence Analyst|Quantitative Analyst|Data Analytics Consultant|Operations Analyst|Marketing Analyst|Project Manager|Business Analyst|Business Insights Analyst|Power BI Developer|IT Systems Analyst|Research & Analytics Director|Machine Learning Engineer|Research & Analytics Director|Data Ops|Chief Analytic Officer|Data Learning Engineer|GIS Analyst|Data Visualizers|Chief Technology Officer|Health Analytics|Big Data Developer|Data Developer|Clinical Analytics|Big Data Architect|Python Engineer|Database Manager|Data Visualization Analyst|Research Analyst|Data Architect|Statistician|AI Product Manager|Quantitative Developer|Principal Big Data Architect|Customer Analytics|Web Analytics|Analytics Officer|Health Data Analyts|Data Engineer|Database Administrator|Strategic Data Analytics Analyst|Data and Analytics Manager|AI Architect|Data Science Director|Data Manager|Reporting/Analytics|Predictive Analytics|Geospatial Data Scientist|Hadoop Administrator|Python Data Developer") ~ "MSBA"))
```
