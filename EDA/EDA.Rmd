...
![](./Job Dashboard 1.png)
It shows data-related job posting in SLC area that was scraped from `Ineed.com`.


![](./Job Dashboard 2.png)
This dashboard page shows the most wanted skills for data-related jobs and rankings for each skills. Users can select different skills to show the trend of the need for each skills in the industry.

![](./Job Dashboard 3.png)

This page shows how many jobs has been posted by each program and each company. Users can see the `top 10` companies who offer the most jobs. Users can check how many jobs are posted by each month.
...
All team members shared ideas for how to scrape data from different websites other than `Indeed.com` and tried multiple different ways eg. `Octoparse`, `ralger`, `rvest`, `selenium`. Ivan worked hard to create a dashboard in `Tableau` and the rest of the team members worked on doing an research for Named Entity Recognition (NER).
