...
```{r}
df <- httr::GET("https://rstudio-connect.business.utah.edu/content/249/data") %>% 
    httr::content()
df
```
...
df$RStudio <-str_detect(df$Description, "RStudio|rstudio|RSTUDIO|R-Studio|r-studio|R-STUDIO|R Studio|r studio|R STUDIO")
